...
$(document).ready(function () {
    $('#btnDownload').click(function () {
        ...
        popupWin.document.write('<html><head><title>::Preview::</title><link href="Styles/StyleSheet.css" rel="stylesheet" /><link href="Styles/Profile.css" rel="stylesheet" /><link href="Content/bootstrap.css" rel="stylesheet" /><link rel="stylesheet" href="https://www.w3schools.com/w3css/3/w3.css"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" /><script src="Scripts/jquery-3.2.1.js"></script></head><body> <button type="submit" class="btn btn-success glyphicon glyphicon-print" id="dwnldResume" onclick="window.print()">Print</button>');
